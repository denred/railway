...
<div class="container mt-4">
    <div class="d-flex flex-column">
        ...
        <div class="d-flex justify-content-center">
            <div class="row">
                <div class="col-auto">
                    <form class="was-validated" action="controller?action=home" method="POST">
                        <input type="hidden" name="from" value="Київ">
                        <input type="hidden" name="to" value="Львів">
                ...
                <div class="col-auto">
                    <form class="was-validated" action="controller?action=home" method="POST">
                        <input type="hidden" name="from" value="Київ">
                        <input type="hidden" name="to" value="Пшемисль">
                        <button type="submit" class="btn btn-info">
                            <fmt:message key="route.kyiv"/>
                            <span class="fas fa-arrows-alt-h"></span>
                ...
                <div class="col-auto">
                    <form class="was-validated" action="controller?action=home" method="POST">
                        <input type="hidden" name="from" value="Київ">
                        <input type="hidden" name="to" value="Харків">
                        <button type="submit" class="btn btn-info">
                            <fmt:message key="route.kyiv"/>
                            <span class="fas fa-arrows-alt-h"></span>
                ...
                <div class="col-auto">
                    <form class="was-validated" action="controller?action=home" method="POST">
                        <input type="hidden" name="from" value="Київ">
                        <input type="hidden" name="to" value="Дніпро">
                        <button type="submit" class="btn btn-info">
                            <fmt:message key="route.kyiv"/>
                            <span class="fas fa-arrows-alt-h"></span>
                ...
                <div class="col-auto">
                    <form class="was-validated" action="controller?action=home" method="POST">
                        <input type="hidden" name="from" value="Львів">
                        <input type="hidden" name="to" value="Пшемисль">
                        <button type="submit" class="btn btn-info">
                            <fmt:message key="route.lviv"/>
                            <span class="fas fa-arrows-alt-h"></span>
        ...
        <div class="row">
            <div class="col d-flex justify-content-center mt-4">
                <div class="input-group w-25">
                    ...
                    <input name="departure_station" type="text" class="form-control" id="from" value="${from}" required>
                </div>
                <div class="d-flex align-items-center mx-2"><span class="fa-lg fas fa-arrows-alt-h"></span></div>
                <div class="input-group w-25">
        ...
        <div class="row">
            <div class="col d-flex justify-content-center mt-4">
                ...
                <div class="input-group w-25 ml-4">
                    ...
                    <select class="form-control" type="time" name="departure_time">
