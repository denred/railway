...
public class HashGeneratorUtil {
    private static final Logger LOGGER = LoggerFactory.getLogger(HashGeneratorUtil.class);
    ...
    public HashGeneratorUtil() {
        ...
        try {
            ...
            LOGGER.error(String.format("No such algorithm: %s", ENCRYPTION_ALGORITHM), e);
        }
    }

    public String generateHash(String password) throws IncorrectDataException {
        if (password == null) {
    ...
    public boolean validatePassword(String inputPassword, String storedPassword) throws IncorrectDataException {
    ...
    private byte[] generateTransitionalHash(String password, byte[] salt) throws IncorrectDataException {
