...
class TrainRepositoryImplTest {
    ...
    @InjectMocks
    private TrainRepositoryImplTest underTest;
    ...
    @Test
    void createTrain() {
        TrainRepository trainRepository = new TrainRepositoryImpl(mockDataSource);
        try {
            ...
            assertEquals(1, trainRepository.create(Train.builder().build()));
